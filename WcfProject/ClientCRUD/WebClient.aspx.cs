...
using System.Linq;
using ClientCRUD.ServiceReference10;
...
namespace ClientCRUD
{
    public partial class WebClient : System.Web.UI.Page
    {
        ...
        public void BindData()
        {
            ...
            GridView1.DataSource = obj.ShowAll();// new
            GridView1.DataBind();
        }
        ...
        protected void GridView1_RowEditing(object sender, GridViewEditEventArgs e)
        {
            ...
            foreach (var x in obj.GetRecordbyId(userId)) // I replaced li with obj.GetRecordbyId(userId) and used client instead of obj
            {
